#!/bin/bash
# Modified to use brightnessctl instead of xbacklight
# original source: https://gitlab.com/Nmoleo/i3-volume-brightness-indicator

# See README.md for usage instructions
bar_color="#7f7fff"
volume_step=2
brightness_step=5 # Use an integer value for steps
max_volume=100
...
# Uses brightnessctl to get the current brightnesso
...
function get_brightness {
    brightnessctl -d intel_backlight get | grep -Po '[0-9]+'
}
